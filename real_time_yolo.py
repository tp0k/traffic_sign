...
# Hàm phát hiện và nhận diện đối tượng
...
# Hàm truy cập vào tệp video
def start_video_detection():
    file_path = filedialog.askopenfilename(initialdir=".", title="Chọn file video", filetypes=(("Video files", "*.mp4"), ("All files", "*.*")))
    if file_path:
